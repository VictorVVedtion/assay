...
/** A hairline vertical divider between tiles. */
function Sep() {
  return (
    <span
      aria-hidden
      className="shrink-0 self-stretch"
      style={{ width: 1, background: "var(--line-soft)" }}
    />
  );
}
...
export function StatRow() {
  ...
  return (
    <section
      ...
      className={cn("panel panel-2", tampered && "tamper-pulse")}
      style={{
        borderColor: tampered ? "var(--sev-tamper-border)" : undefined,
      }}
    >
      <div className="flex items-stretch gap-4 px-4 py-2.5 overflow-x-auto">
        {/* total requests */}
        <StatTile
          label="证据记录 · evidence"
